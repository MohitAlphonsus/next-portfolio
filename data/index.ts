...
export const projects = [
	{
		...
		link: "https://adminly.netlify.app/",
	},
	{
		id: 2,
		title: "Realtime Chat App with MERN & Socket.io",
		des: "A real-time chat application built with React (frontend) and Express + Socket.io + MongoDB (backend), enabling user authentication and live messaging between users.",
		img: "/chat-app.svg",
		iconLists: [
			"/re.svg",
			"/tail.svg",
		...
		link: "https://chat-app-wt2x.onrender.com/login",
	},
	{
		id: 3,
